...
{//var_dump($_SESSION['wishlist']);
    $favv=$_SESSION['wishlist'];
    if(in_array($_GET['id'], $favv))
    $wished=1;
}*/
    if (!$produit){
                            ...
                            <div class="col-md-6">
                                <div class="product-gallery">
                                    <figure class="product-main-image">
                                        <img id="product-zoom" src="assets/images/products/single/extended/1-big.jpg" data-zoom-image="assets/images/products/single/extended/3-big.jpg" alt="product image">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="product-details-action">
                                        ...
                                        <div class="details-action-wrapper">
                                            <a href="#" onclick="addwish()" class="btn-product btn-wishlist" title="Wishlist"><span>Add to Wishlist</span></a>
