                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                ...
                                                <a href="http://localhost/proj/view/product.php?id=13">
                                                    <img src="../../assets/assets/images/products/single/extended/p1.jpg" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="product.html"><?php echo $produit['titre']; ?></a></h3><!-- End .product-title -->
