    ...
    if (isset($_GET['id'])) {
        if (!empty($_POST)) {
          ...
          //  $id = isset($_POST['id']) ? $_POST['id'] : NULL;
            ...
            // Update the record
            $stmt = $pdo->prepare('UPDATE reclamation SET  nom = ?, ref = ?, email = ?, type =?, description =?, status= ?, idUser=? WHERE id = ?');
            $stmt->execute([ $nom, $ref, $email,$type, $description, $status,$idUser, $_GET['id']]);
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tr>
            <td>ref</td>
            <td><input type='text' name='ref'  value ="<?php echo $reclamation['ref'];?>" class='form-control' /></td>
        </tr>
