    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../reclamation/listReclamation.php" class="nav-link">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../categorie/listcategorie.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List categorie</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../categorie/ajoutCategorie.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <br>
              <form action="modifiercategorieAction.php?id=<?=$categorie['id']?>" method="POST">
        ...
        <tr>
            <td>subCat</td>
            <td><input type='text' name='subCat'  value ="<?php echo $categorie['subCat'];?>" class='form-control' /></td>
        </tr>
        
        <tr>
            <td>idReclamation</td>
            <td><input type='text' name='idReclamation'  value ="<?php echo $categorie['idReclamation'];?>" class='form-control' /></td>
        </tr>
